...
- `"` - это символ-индикатор начала/конца текстовых данных. Внутри этих символов располагаются текстовые данные.
...
Макрос в Rust — это способ автоматически генерировать код во время компиляции. Макросы позволяют писать меньше кода и избегать повторений.

В макросах Rust оператор используется для обработки нескольких аргументов или повторяющихся элементов.
